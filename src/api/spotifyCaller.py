...
class SpotifyCaller:
    ...
    def __repr__(self) -> str:
        return f'Token: {self.__token}' if self.tokenIsValid() else 'No valid token to display...'
    ...
    def getTrack(self, songID):
        return requests.get(f'{ENDPOINT}/tracks/{songID}', headers=self.__headers).json()
